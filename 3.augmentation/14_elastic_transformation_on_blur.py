...
original_images = [imageio.v2.imread(f'../512_data_with_augmentation/x/x_{i}.png') for i in range(956, 967)]
masks = [imageio.v2.imread(f'../512_data_with_augmentation/y/y_{i}.png') for i in range(956, 967)]
